...
use crate::generate::{FrameworkImportCtx, FunctionsGen, StructClassImportCtx, StructsGen};
...
async fn main() -> Result<()> {
    ...
    let manifest = parse_gen_manifest_from_file(Path::new("ts/examples/gen/"/*&args.manifest*/))?;
