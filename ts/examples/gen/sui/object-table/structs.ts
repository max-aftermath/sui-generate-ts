...
export function isObjectTable(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V36}::object_table::ObjectTable` + '<'); }
